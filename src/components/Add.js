...
class Add extends Component {
    ...
    onBtnClickHandler() {
        ...
        console.log('agreeNotChecked', this.state.agreeNotChecked);
        console.log('authorIsEmpty', this.state.authorIsEmpty);
        console.log('textIsEmpty', this.state.textIsEmpty);
